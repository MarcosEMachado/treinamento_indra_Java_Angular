...
public class ContaBancariaService extends GenericCrudService<ContaBancaria, Long, ContaBancariaRepository>{
	...
	public void depositar(String agencia, String numeroConta, double valor, String tipoOp) {
		ContaBancaria conta = this.consultarConta(agencia, numeroConta);
		conta.setSaldo(conta.getSaldo() + valor);
		super.salvar(conta);
		if (tipoOp.equals("DEPOSITAR")) {
			operacaoContaService.salvarOperacao('C', valor, conta, "Depósito Recebido");
		}else if (tipoOp.equals("TRANSFERENCIA")) {
			operacaoContaService.salvarOperacao('C', valor, conta, "Transferência Recebida");
		}
		
	}
	
	public void sacar(String agencia, String numeroConta, double valor, String tipoOp) {
		ContaBancaria conta = this.consultarConta(agencia, numeroConta);
		...
		if (tipoOp.equals("SAQUE")) {
			operacaoContaService.salvarOperacao('D', valor, conta, "Saque Realizado");
		}else if (tipoOp.equals("TRANSFERENCIA")) {
			operacaoContaService.salvarOperacao('D', valor, conta, "Transferência Enviada");
		}
	}
	...
	public void transferir(TransferenciaBancariaDTO dto) {
		...
		this.sacar(dto.getAgenciaOrigem(), dto.getNumeroContaOrigem(), dto.getValor(), "TRANSFERENCIA");
		this.depositar(dto.getAgenciaDestino(),dto.getNumeroContaDestino(), dto.getValor(), "TRANSFERENCIA");
	}
